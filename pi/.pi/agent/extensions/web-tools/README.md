...
- `~/.pi/agent/extensions/web-tools/settings.ts`

## Source of truth

- extension entry: `~/.pi/agent/extensions/web-tools/index.ts`
- settings/defaults: `~/.pi/agent/extensions/web-tools/settings.ts`
- fetch tool: `~/.pi/agent/extensions/web-tools/webfetch.ts`
- search tool: `~/.pi/agent/extensions/web-tools/websearch.ts`
- Exa provider: `~/.pi/agent/extensions/web-tools/providers/exa.ts`
