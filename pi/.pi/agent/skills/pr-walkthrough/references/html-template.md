...
<head>
  ...
  <title>[PR ID] Walkthrough — [Short Title]</title>
...
Fixed navigation bar with PR badge, title, prev/next buttons, and slide counter.

```html
<div class="topbar">
  <div class="topbar-left">
    <span class="pr-badge">PR #42</span>
